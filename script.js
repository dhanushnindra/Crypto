...
box.innerHTML = "<thead class='text-xs uppercase bg-emerald-700 text-emerald-400'> <tr> <th scope='col' class='py-6 px-6'>Coin</th> <th scope='col' class='py-6 px-6'>Price</th> </tr> </thead>";
